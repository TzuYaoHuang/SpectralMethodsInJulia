...
md"This notebook try to demonstrate how to solve the second order wave equation with FFT Chebyshev and leap-frog method. $\partial_{tt} u = \partial_{xx}u$ with fixed boundary condition $u(\pm 1) = 0$."
