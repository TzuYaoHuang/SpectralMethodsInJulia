...
# ╔═╡ f4d4b11a-658e-11f0-04a5-e5693f60bc96
using Plots, FFTW, ToeplitzMatrices, LinearAlgebra, LaTeXStrings

# ╔═╡ 3eec0b7d-d240-496d-8fdf-2be8241f1664
include("Chebyshev.jl"); using .Chebyshev

# ╔═╡ 2851b903-f534-4f75-9611-3907223d9b0b
md"Check whether or not the differentiation matrix from periodic sinc function."

# ╔═╡ 6306a12b-4e31-4360-b378-e5e0dd32bac8
begin
	N = 5
	D1 = SincDiff1(N)
	D1_2 = D1^2
